...
static const char *fonts[]          = { "ShureTechMono Nerd Font:size=13" };
...
static const char *xrandrbrdown[] = { "xrandr", "--output", "eDP1", "--brightness", "0.5", NULL };
static const char *xrandrbrup[] = { "xrandr", "--output", "eDP1", "--brightness", "1.5", NULL };
static const char *xrandrbrneutral[] = { "xrandr", "--output", "eDP1", "--brightness", "1", NULL }; 
...
static Key keys[] = {
	...
	{ MODKEY,                       XK_F3,     spawn,          {.v = upvol   } },
        ...
        { MODKEY,                       XK_F8,     spawn,          {.v = xrandrbrdown} },
        { MODKEY,                       XK_F9,     spawn,          {.v = xrandrbrup} },
        { MODKEY,                       XK_F10,    spawn,          {.v = xrandrbrneutral} },
